  ...
  return (
    ...
    >
      <div className="flex items-start gap-2">
        <div
          className="mt-1 flex h-8 w-6 cursor-grab active:cursor-grabbing items-center justify-center text-muted-foreground hover:text-foreground touch-none rounded hover:bg-accent/50 shrink-0"
          {...attributes}
          {...listeners}
